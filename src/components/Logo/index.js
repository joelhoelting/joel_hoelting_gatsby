...
var fadeSubtitle = Radium.keyframes({
  '0%': {
    opacity: 0,
...
const Logo = () => {
  return (
    <div style={styles.flexDiv}>
      <svg style={animations.drawLine} id="desktop-logo" style={[styles.desktop, styles]} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1356.8 181.5">
      ...
      <svg id="mobile-logo" style={[styles.mobile, styles]} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1288.2 622.7">
        <title>Joel Hoelting</title>
        <path style={animations.drawLine} id="J" d="M453,210.9c0,69.6-57.2,101.4-129.1,101.4V278.5c53.2,0,95.3-21.1,95.3-67.6v-99H356V78.4h97Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        ...
        <path style={animations.drawLine} id="E" d="M758.8,278.5H867.6v33.8H724.7V78.4H867.2v33.8H758.8v65.9H864.9v34.1H758.8Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="L" d="M918.1,278.5h110.1v33.8H884.3V78.4h33.8Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="H" d="M78.9,556.6h99V457.9h34.1V691.8H178V590.1h-99V691.8H45.1V457.9H78.9Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        ...
        <path style={animations.drawLine} id="L-2" data-name="L" d="M522.9,658H633v33.8H489.1V457.9h33.8Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="T" d="M661.1,692.8V489H590.1V457.6H765.4V489H694.9V692.8Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="I" d="M897.9,491.4H854.4V658h43.5v33.8H777.2V658h43.5V491.4H777.2V457.9H897.9Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="N" d="M913,691.8V457.2l26.1.3,114.1,164.9V457.6h33.5V691.8h-26.8L946.8,528.2V691.8Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
        <path style={animations.drawLine} id="G" d="M1292.4,541.6c-9.4-37.8-45.5-51.5-75.3-51.5-45.8,0-81.3,35.8-81.3,85s35.5,86,81.3,86c28.8,0,59.5-13.4,73.6-47.5H1204V579.7h126.1c-1.7,19.7-3.3,32.8-6.4,40.5v-.3c-16.1,44.8-64.2,73.6-106.7,73.6-65.6,0-115.1-49.5-115.1-118.4s50.5-118.8,115.1-118.8c44.8,0,99,23.1,111.4,85.3Z" transform="translate(-43.6 -73.6)" fill="none" stroke="#24255d" />
      </svg>
